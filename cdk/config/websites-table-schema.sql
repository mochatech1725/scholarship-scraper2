...
VALUES (
    ...
    true,
    'GumLoopScraper',
    '{"scholarshipLinks": "a[href*=\"/scholarship/\"]", "title": "h1, h2, .scholarship-title", "amount": ".amount, .award-amount, [data-testid=\"amount\"]", "deadline": ".deadline, .due-date, [data-testid=\"deadline\"]", "description": ".description, .summary, [data-testid=\"description\"]", "organization": ".organization, .sponsor, [data-testid=\"organization\"]"}',
    NOW(),
    NOW()
)
ON DUPLICATE KEY UPDATE
